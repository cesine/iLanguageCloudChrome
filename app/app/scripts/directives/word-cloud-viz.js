...
angular.module('WordCloudApp').directive('wordCloudViz', function() {
  ...
  return {
    ...
    controller: function($scope, $element) {
      ...
      var cloud = {
        orthography: $scope.wordCloud.orthography,
      ...
      if ($scope.wordCloud.orthography && $scope.wordCloud.orthography.length > 300) {
        cloud.height = 400;
      } else {
        cloud.height = 200;
      }
      ...
      if (!cloud.title && cloud.orthography) {
        var titleLength = cloud.orthography.length > 31 ? 30 : cloud.orthography.length - 1;
        cloud.title = cloud.orthography.substring(0, titleLength) + '...';
      }
